...
{
    public class MoveTicketClosurestage : IPlugin
    {
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                ...
                var processingStageId = new Guid("ef0a2c39-d6d9-4b29-a39b-53dc539f0982");
                tracing.Trace($"📌 Using hardcoded 'closure' stage ID: {processingStageId}");
