        ...
        public class SLALevel2 : IPlugin
        {
            public void Execute(IServiceProvider serviceProvider)
            {
                ...
                try
                {
                    ...
                    if (!userIds.Any())
                    {
                        tracing.Trace("No Department Manager users found.");
                        return;
                    }
                    ...
                    Entity DepartmentManager = service.RetrieveMultiple(new QueryExpression("systemuser")
                    {
                    ...
                    if (!DepartmentManager.Contains("internalemailaddress"))
                    ...
                    {
                        ["partyid"] = new EntityReference("systemuser", DepartmentManager.Id)
                    };
                ...
                {
                    ["subject"] = "Level 2 Escalation: Immediate Attention Needed for Case",
                    ["description"] = $@"
        <html>
        <body>
            ...
            <p>Support Escalation Team</p>
                ...
                catch (Exception ex)
                {
                    ...
                    throw new InvalidPluginExecutionException("Failed to notify Department Manager.", ex);
                }
            }
              ...
              <entity name='systemuser'>
                ...
                <link-entity name='position' from='positionid' to='positionid' link-type='inner'>
                  <filter>
                    ...
                    tracing.Trace($"Found {result.Entities.Count} Department Manager users in team {teamId}");
